...
| Field | Your answer |
|-------|-------------|
| **Full name** | Ahmad Ibrahim Anwar Saad |
| **Email** | ahmad.motawe2734@gmail.com |
| **Group** | G9 |
...
R3 runs first:alarm and lamp are set correctly

R1 runs second: OCCUPIED bit is clear, so R1's else branch fires and clears LAMP again.
